...
const PricingSchema = z
  .object({
    ...
    discountValidFrom: z.string().datetime().nullable(),
...
export const registerPricingSwagger = (registry: OpenAPIRegistry, bearerAuth: any) => {
  registry.registerPath({
    ...
    description:
      'Create or update pricing for a specific vehicle or globally (if vehicleId is omitted).',
    security: [{ bearerAuth: [] }],
    request: {
      body: {
        content: {
          'application/json': {
            schema: z
              .object({
                ...
                discountValidFrom: z.string().datetime().optional(),
  ...
  registry.registerPath({
    ...
    description:
      'Get pricing for a specific vehicle. Falls back to global pricing if specific is not found.',
    request: {
      query: z.object({
  ...
  registry.registerPath({
    ...
    description:
      'Delete pricing for a specific vehicle. Will fallback to global pricing afterwards.',
    security: [{ bearerAuth: [] }],
    request: {
      params: z.object({
